...
add_czech_regions_population <- function(regions) {
  ...
  region_popul <- tribble(
    ~region_nuts3, ~popul, ~popul_male, ~popul_female, ~mean_age, ~mean_age_male, ~mean_age_female,
    "CZ010", 1308632,	638009,	670623,	41.9,	40.5,	43.3,
    "CZ020", 1369332,	676696,	692636,	41.2,	40.0,	42.4,
    "CZ031", 642133,	317268,	324865,	42.7,	41.4,	43.9,
    "CZ032", 584672,	290226,	294446,	42.7,	41.5,	43.9,
    "CZ041", 294896,	145674,	149222,	42.9,	41.5,	44.2,
    "CZ042", 820789,	407395,	413394,	42.0,	40.7,	43.4,
    "CZ051", 442356,	217791,	224565,	42.1,	40.7,	43.5,
    "CZ052", 551021,	271591,	279430,	43.1,	41.6,	44.5,
    "CZ053", 520316,	257948,	262368,	42.4,	41.0,	43.8,
    "CZ063", 509274,	253061,	256213,	42.8,	41.4,	44.1,
    "CZ064", 1187667,	582516,	605151,	42.4,	40.9,	43.8,
    "CZ071", 632492,	309620,	322872,	42.8,	41.2,	44.3,
    "CZ072", 582921,	285883,	297038,	43.1,	41.4,	44.7,
    "CZ080", 1203299,	590516,	612783,	42.7,	41.1,	44.2
  )
  regions %>% 
